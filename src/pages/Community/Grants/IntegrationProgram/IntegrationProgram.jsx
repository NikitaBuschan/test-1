    ...
    <SGrantProgram>
      ...
      <main className="wrap">
        ...
        <div className="formBlock">
          ...
          <h2>Welcome to InteractWith Integration Program!</h2>
          <Formik
            initialValues={{
              message1: "",
              message2: "",
          ...
          >
            {({ isSubmitting, errors }) => (
              <Form className="form">
                <div className="block">
                  <p>
                    Please provide a description of your app\dapp including OS,
                    industry (gaming, lifestyle, Esport, education, etc):
                  </p>
                  <Field
                ...
                <div className="block">
                  <p>
                    Please provide details of your user base numbers, downloads,
                    geographically and other relevant information:
                  </p>
                  <Field
                ...
                <div className="block">
                  <p>
                    Please add direct links to your company, IOS\Android,
                    website, social, LinkedIn and other relevant links:
                  </p>
                  <Field
