...
export default function BusinessProgram() {
    ...
    <SGrantProgram>
      ...
      <main className="wrap">
        ...
        <div className="formBlock">
          ...
          <h2>Welcome to InteractWith Business Program!</h2>
          <Formik
            initialValues={{
              message1: "",
              message2: "",
              ...
              <Form className="form">
                <div className="block">
                  <p>
                    ...
                    with business development, networking and business
                    relationships and in which sectors you are mostly focused:
                  </p>
                  <Field
                ...
                <div className="block">
                  <p>
                    Please name projects and companies you leverage your skills
                    to assist them with business initiatives and describe the
                    process and results:
                  </p>
                  <Field
